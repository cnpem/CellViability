...
\begin{figure}[htbp]
  ...
  \setlength{\tabcolsep}{6pt}
    ...
    \begin{tabular}{>{\centering\arraybackslash}m{3.5cm} c c c}
      ...
      \includegraphics[width=0.25\textwidth, valign=m]{panel/A01.png} &
      \includegraphics[width=0.25\textwidth, valign=m]{panel/G19.png} &
      \includegraphics[width=0.25\textwidth, valign=m]{panel/A23.png} \\
      \specialrule{0.25pt}{2pt}{2pt}

      % Row 2: Columbus
      \footnotesize\textbf{Columbus (v2.4.0.104236)} &
      \includegraphics[width=0.25\textwidth, valign=m]{panel/columbus_SLEV_S1_A01.png} &
      \includegraphics[width=0.25\textwidth, valign=m]{panel/columbus_SLEV_S1_G19.png} &
      \includegraphics[width=0.25\textwidth, valign=m]{panel/columbus_SLEV_S1_A23.png} \\
      &
      \scriptsize$N_c = 2515$ &
      \scriptsize$N_c = 204$ &
      \scriptsize$N_c = 184$ \\
      ...
      \includegraphics[width=0.25\textwidth, valign=m]{panel/cellpose3_SLEV_S1_A01.png} &
      \includegraphics[width=0.25\textwidth, valign=m]{panel/cellpose3_SLEV_S1_G19.png} &
      \includegraphics[width=0.25\textwidth, valign=m]{panel/cellpose3_SLEV_S1_A23.png} \\
      &
      \scriptsize$N_c = 3483$ &
      \scriptsize$N_c = 249$ &
      \scriptsize$N_c = 221$ \\
      ...
      \includegraphics[width=0.25\textwidth, valign=m]{panel/cellpose4_SLEV_S1_A01.png} &
      \includegraphics[width=0.25\textwidth, valign=m]{panel/cellpose4_SLEV_S1_G19.png} &
      \includegraphics[width=0.25\textwidth, valign=m]{panel/cellpose4_SLEV_S1_A23.png} \\
      &
      \scriptsize$N_c = 3566$ &
      \scriptsize$N_c = 228$ &
      \scriptsize$N_c = 189$ \\
      ...
      \includegraphics[width=0.25\textwidth, valign=m]{panel/stardist_SLEV_S1_A01.png} &
      \includegraphics[width=0.25\textwidth, valign=m]{panel/stardist_SLEV_S1_G19.png} &
      \includegraphics[width=0.25\textwidth, valign=m]{panel/stardist_SLEV_S1_A23.png} \\
      &
      \scriptsize$N_c = 3433$ &
      \scriptsize$N_c = 272$ &
      \scriptsize$N_c = 239$ \\
...
\subsection{Controle de qualidade das placas}

\subsection{Visualização dos dados}

\subsection{Seleção dos compostos candidatos (\textit{hits})}
