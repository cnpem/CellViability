...
\begin{tikzpicture}[scale=0.42, every node/.style={transform shape, inner sep=0pt}]
  ...
  \begin{umlpackage}{CellViability}
    ...
    \begin{umlpackage}[x=-6, y=0]{protocols}

      \umlclass[x=0, y=0, width=80ex]{CellViabilityProtocol}{
        +config : dict[str, any] \\
        +name : str \\
        +screen : Screen
      }{
    ...
    \begin{umlpackage}[x=0, y=-12]{screening}
      ...
      \umlclass[x=7, y=0, width=30ex]{Well}{
        +name : str \\
        +images : list[Image]
      }{
      ...
      \umlclass[x=17, y=0, width=40ex]{Image}{
        +name : str \\
        +filename : str \\
        +field : int \\
    ...
    \begin{umlpackage}[x=0, y=0]{core}

      \umlclass[x=10, y=0, type=module, width=30ex]{cli}{}{
  ...
  \umlunicompo[pos1=3.0,geometry=|-|,anchor1=-90,anchor2=90,mult1=1,mult2=1..1]{CellViabilityProtocol}{Screen}
  \umlunicompo[geometry=-|-,anchor1=30,anchor2=-160,mult1=1,mult2=1..*]{Screen}{Plate}
  \umlunicompo[geometry=-|-,anchor1=30,anchor2=-160,mult1=1,mult2=1..*]{Plate}{Well}
  \umlunicompo[geometry=-|-,anchor1=20,anchor2=-160,mult1=1,mult2=1..*]{Well}{Image}
  \umluniassoc[mult1=1,mult2=1]{cli}{CellViabilityProtocol}
