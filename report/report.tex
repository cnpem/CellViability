...
\begin{enumerate}
  ...
  \item StarDist \cite{Schmidt2018,Weigert2020,Weigert2022}.
\end{enumerate}
...
Após integração das placas, a seleção dos compostos candidatos (\textit{hits}) baseou-se nos valores normalizados de inCPE, adotando-se um limiar definido pelo usuário. Compostos com alto índice de inibição foram classificados como potenciais inibidores do efeito citopático viral.
...
O pacote de código aberto \texttt{CellViability} (GPL 3.0) foi desenvolvido com o objetivo de implementar um protocolo robusto e reproduzível para o processamento de imagens provenientes de ensaios fenotípicos de viabilidade celular, aplicados à descoberta de fármacos.
